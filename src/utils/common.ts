...
export function isWithinWorkingHours(
  ...
  const workingDay = workingHours.find((workingHour) =>
    DayOfWeek.of(workingHour.weekday).equals(currentDay),
  );
  ...
  return (
    currentTime.isAfter(LocalTime.parse(workingDay.startTime)) &&
    currentTime.isBefore(LocalTime.parse(workingDay.endTime))
  );
}
